...
const RoomDetails = () => {
  ...
  return room && (
     ...
     <div className='flex flex-col lg:flex-row mt-6 gap-6'>
      ...
      <div className='flex flex-col md:flex-row md:justify-between mt-10'>
        <div className='flex flex-col'>
            <h1 className='text-3xl md:text-4xl font-playfiar'>Experience Luxury Like Never Before</h1>
      ...
      p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
            ...
            <div className='flex flex-col'>
                ...
                <input type="number" id='guests' placeholder='0' className='max-w-20 roubded border border-gray-300 px-3
    ...
    <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will be allocated on the ground floor according to the availability. You get a comfortable Two bedroom apartment which has a true city feeling. The price quoted is for two guests, at the guest slot please mark the number of guests to get the exact price for groups.</p>
    </div>

...
const HotelReg = () => {
  ...
  return (
    <div onClick={() => setShowHotelReg(false)} className='fixed top-0 bottom-0 left-0 right-0 z-50 flex items-center justify-center bg-black/70'>
      <form onSubmit={onSubmitHandler} onClick={(e) => e.stopPropagation()} className='flex bg-white rounded-xl w-full max-w-4xl max-md:mx-2'>
        <img src={assets.regImage} alt="hotel registration illustration" className='w-1/2 rounded-xl hidden md:block' />

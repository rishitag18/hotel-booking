    ...
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 pt-20 pb-24'>
      ...
      <div className="flex flex-wrap items-center gap-6 mt-20 mb-10">
        {testimonials.map((testimonial) => (
          <div 
            key={testimonial.id} 
            className="bg-white p-6 rounded-xl shadow w-[400px] h-[240px] flex flex-col justify-between"
          >
...
// Note: The StarRating component is assumed to be a separate component that handles the display of star ratings.